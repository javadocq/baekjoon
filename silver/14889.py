...
# 2 초	512 MB	123640	62023	36941	47.154%
# 문제
...
def solution(n, board):
    ...
    all_team = list(combinations(board_list, n//2))
    
    for i in range(len(all_team) // 2):
        start_team = all_team[i]
        link_team = list(set(board_list) - set(start_team))
        ...
        link_score = 0
        for i in range(0, len(link_team) - 1):
