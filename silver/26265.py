...
# 2 초	256 MB	1303	851	687	67.024%
# 문제
...
for _ in range(num):
    mento_menti.append(input().split())


mento_menti = sorted(mento_menti, key=lambda x : x[1], reverse=True)
mento_menti = sorted(mento_menti, key= lambda x : x[0])

for i in mento_menti:
    print(i[0] + ' ' + i[1])
